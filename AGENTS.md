...
- API pattern: static FMP three-statement refresh jobs plus REST calls to Finnhub, API Ninjas, Massive API, TAAPI.io, Gemini; proxied via Vite dev server + Vercel rewrites/API routes

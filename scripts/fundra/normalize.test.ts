...
import { buildWarnings, cagr, normalizeFundraRecord, normalizeNumber, ratio } from "./normalize.ts";
...
test("normalizeFundraRecord builds a stock record with full-unit money values and decimal ratios", () => {

...
export type RawEdgequityPayload = {
  ticker: string;
  profile: RawObject;
  metrics: RawObject;
...
function normalizeHistory(raw: RawEdgequityPayload): EdgequityStockRecord["history"] {
...
function growthFromHistory(
  history: EdgequityStockRecord["history"],
...
export function normalizeEdgequityRecord(raw: RawEdgequityPayload): EdgequityStockRecord {

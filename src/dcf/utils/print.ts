...
<div class="hdr"><div><div class="logo">Valu<em>Wise</em></div><div class="title">${ticker} &mdash; DCF Analysis</div><div class="subtitle">${companyNameStr} &nbsp;&bull;&nbsp; ${scenarioLabel}</div></div><div class="hdr-r"><div><strong>Date</strong>&nbsp; ${dateStr}</div><div><strong>Model</strong>&nbsp; Unlevered FCFF / Gordon Growth Terminal Value</div><div><strong>Data</strong>&nbsp; Financial Modeling Prep</div></div></div>

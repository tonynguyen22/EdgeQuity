...
<div class="footer"><strong>Disclaimer:</strong> This DCF analysis is provided by Fundra for informational and educational purposes only. It does not constitute investment advice or a solicitation to buy or sell any security. All projections are based on historical data from Financial Modeling Prep and user-defined assumptions. Conduct independent due diligence before making any investment decisions.</div>

...
type FundraValueFormat = FundraColumn['format'];
type FundraValue = string | number | null | undefined;
...
export function formatFundraValue(value: FundraValue, format: FundraValueFormat): string {
...
export function getColumnValue(stock: FundraStockRecord, column: FundraColumn): string | number | null {

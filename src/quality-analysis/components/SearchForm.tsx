    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold tracking-tight mb-2" style={{ color: 'var(--vw-text-primary)' }}>
          Quality <span style={{ color: 'var(--vw-accent)' }}>Analysis</span>
        </h1>
        <p className="text-sm" style={{ color: 'var(--vw-text-secondary)' }}>
          Comprehensive financial quality report with A–D grades
        </p>
      </div>
      ...
      <div className="w-full max-w-2xl mt-8 rounded-xl p-6 space-y-4" style={{ background: 'rgba(17, 24, 39, 0.5)', border: '1px solid var(--vw-border-dim)' }}>
        ...
        <ul className="space-y-2.5">
          {[
            "Scores a company's financial health across four categories with letter grades (A–D)",
            "Evaluates profitability, balance sheet strength, growth, and cash flow quality",
            "Runs advanced models like Altman Z-Score (bankruptcy risk) and Piotroski F-Score (financial strength)",
            "Flags specific risk warnings like high debt, declining margins, or negative cash flow",
          ].map((item, i) => (
